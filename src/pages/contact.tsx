...
const svgs = {
    gitHub: (
        <svg css={svgStyle} width='32' height='32' viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
    ...
    linkedIn: (
        <svg css={svgStyle} width='32' height='32' viewBox='0 0 36 37' fill='none' xmlns='http://www.w3.org/2000/svg'>
